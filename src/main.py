...
if __name__ == "__main__":
    ...
    img = cv2.imread('C:/Users/akasp/OneDrive/Desktop/die-melodie/src/output/musicSheet.jpg', 0)
        ...
        for j in range(len(staffPrimitive)):
            ...
            if (staffPrimitive[j].getPrimitive() == "note"):
                if(j != len(staffPrimitive) - 1):
                    ...
                    str5 = "{}".format(staffPrimitive[j].getPitch())
                else:
    ...
    for i in range(len(staffs)):
        ...
        for j in range(len(bars)):
            ...
            for k in range(len(primitives)):
                ...
                str8 = "{} {} {}\n".format(primitives[k].getPrimitive(), primitives[k].getPitch(), primitives[k].getDuration())
                f.write(str8)
                time += duration
            print("------\n")
            str9="------"
    ...
    f = open("C:/Users/akasp\OneDrive/Desktop/die-melodie/src/convertedNotes.txt", "r")
    # insert the texts in pdf
    for x in f:
        pdf.cell(70, 10, txt=x, ln=1, align='L')
        # save the pdf with name .pdf
    pdf.output("C:/Users/akasp\OneDrive/Desktop/die-melodie/src/output/convertedNotes.pdf")